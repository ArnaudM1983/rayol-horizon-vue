<template>
  <header class="absolute top-0 left-0 w-full z-50 bg-transparent text-white">
    ...
    <div class="flex justify-between items-center p-6 lg:px-12">
      ...
      <!-- Réserver Button -->
      <a href="#contact"
        class="hidden md:inline-block text-white border border-white px-6 py-2 text-lg font-light cursor-pointer bg-transparent rounded-none hover:bg-white hover:text-black transition">
        Je réserve
      </a>
